        ...
        <section class="content-header">
            <form class="form-horizontal" method="post" action={{ route('students.unrollCourse', $course->id) }}>
                ...
                <section class="content">
                    ...
                    <div class="card card-info" style="max-width: fit-content;margin-inline: auto;">
                        <a href="{{route('students.assignForm',$course->id)}}"  type="submit" class="btn btn-success">Add Students</a>
                    </div>
                    ...
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        <div class="form-horizontal" method="post" action={{ route('courses.edit', $course->id) }}>
                            {{-- Students Info table --}}
