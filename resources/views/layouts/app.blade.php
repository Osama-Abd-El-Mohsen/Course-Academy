    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a  href={{route("home")}} class="brand-link">
                ...
                <span  href={{route("home")}} class="brand-text font-weight-light">Course Academy</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{asset('admin/01.jpeg') }}" class="img-circle elevation-2"alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Osama Abd El Mohsen</a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <a href="https://github.com/Osama-Abd-El-Mohsen">Osama Abd El Mohsen</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
